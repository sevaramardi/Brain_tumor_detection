...
class ESA(nn.Module):
    def __init__(self, in_chan, conv = nn.Conv2d):
        super(ESA, self).__init__()
        #f = in_chan // 4
        self.conv1 = conv(in_chan,in_chan, kernel_size=1)
        self.conv_f = conv(in_chan, in_chan, kernel_size=1)
        self.conv_max = conv(in_chan, in_chan, kernel_size=1, padding=1)
        self.conv2 = conv(in_chan, in_chan, kernel_size=1, stride=1, padding=0)
        self.conv3 = conv(in_chan, in_chan, kernel_size=3, padding=1)
        self.conv3_ = conv(in_chan, in_chan, kernel_size=3, padding=1)
        self.conv4 = conv(in_chan, in_chan, kernel_size=1)
